...
\subsection{Responsable MiDiro}\label{sec:responsable-midiro}
La personne responsable des MiDiro assure la planification, l'organisation et la tenue des conférences MiDiro.

\subsection{Responsable Compétition}\label{sec:responsable-competition}
...
\subsection{Responsables Soirées et «~Party~» (2 responsables)}\label{sec:responsable-party}
...
\subsection{Responsable Sport}\label{sec:responsable-sport}
...
\subsection{Responsable de la promotion des événements}\label{sec:responsable-promotion-evenements}
...
\subsection{Responsable du serveur}\label{sec:responsable-serveur}
...
\subsection{Les MiDiros}\label{sec:midiros}
\begin{description}
