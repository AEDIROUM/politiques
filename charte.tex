...
Tout.e membre d'un groupe identitaire dit \textit{sous-représenté} et/ou \textit{désavantagé}, peu importe quel est ce groupe, voulant offrir une opportunité ou un service aux membres de son groupe a droit, sous réserve d'un vote par le conseil d'administration, à du soutien financier raisonnable pour le faire.
