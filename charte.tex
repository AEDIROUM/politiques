...
Si une personne dite \textit{de confiance} par le Conseil Exécutif est sur le campus durant la session d'été, cette personne a préséance pour le poste. Le Conseil Exécutif est invité à lui remettre les clés, pour permettre aux Membres de profiter du local durant la session d'été.
