...
\item[Vice-président interne] Le vice-président interne est responsable de tout dossier concernant les relations entre les professeurs et ses membres ou les cours auxquels ses membres assistent. Il doit consulter et informer les responsables d'année concernés lors du traitement de ces dossiers. Il est délégué d'office de l'AÉDIROUM au comité des études et à l'assemblée départementale du DIRO. Il remplace, en premier lieu, le président en cas d'absence ou d'incapacité de celui-ci.
...
Doit absolument être recommandée par le RFIUM avant de postuler à l'élection de l'AÉDIROUM. Aucune candidate ne peut être élue sans cette recommendation préalable.

Cette recommendation de la candidate doit, en plus ~:
\begin{itemize}
    \item Avoir reçu l'approbation de 50\%+1 vote de la part du RFIUM;
    \item Avoir eu lieu lors d'une AG ou CA du RFIUM durant la même session ou durant la session précédant celle-ci;
    \item Avoir eu lieu lorsque le conseil administratif du RFIUM était composé d'au moins 5 membres actifs;
\end{itemize}
