...
Pour chaque poste soumis au suffrage, le présidence d'élection, si elle a droit de vote, doit consigner son vote qui ne sera dévoilé qu'en cas d'égalité.
...
\begin{description}
\item[Destitution] Lorsqu'une personne membre du C.A. est destitué par les personnes membres réunis en assemblée générale, l'élection de sa succession devrait avoir lieu au cours de la même assemblée générale.
...
Les réunions du C.A. sont typiquement présidées par la présidence de l'AÉDIROUM. Le secrétariat de l'AÉDIROUM agit typiquement au secrétariat d’assemblée. Il revient aux personnes membres du C.R. de choisir parmi elles un présidence et un secrétariat d'assemblée au début de chaque réunion.
...
La présidence de référendum est nommée par le C.A. Pour chaque question ou proposition soumise au suffrage, la présidence, si elle a droit de vote, doit consigner son vote qui ne sera comptabilité qu'en cas d'égalité.
