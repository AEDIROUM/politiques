...
\begin{description}
    \item[AG] Assemblée générale;
    \item[CA] Réunion du Conseil d'Administration;
...
Les personnes membres ont le droit de participer à toutes les activités de l'AÉDIROUM, de recevoir les avis de convocation aux assemblées des membres, d'assister à ces assemblées et d'y voter. Celles-ci sont éligibles comme membres du Conseil Exécutif et d'administration de l'AÉDIROUM.

Les drois conférés à chaque personnes membres sont conditionnels à ce que celles-ci acquittent entièrement sa cotisation
...
Après la vérification du quorum, les membres présents désignent la présidence et le secrétariat d'assemblée, normalement la présidence et le secrétariat de l'AÉDIROUM, respectivement.
...
La présidence d'élection est nommée par les membres présents. La présidence d'élection ne peut être candidate.

Pour chaque poste soumis au suffrage, la présidence d'élection, si elle a droit de vote, doit consigner son vote qui ne sera dévoilé qu'en cas d'égalité.
...
Seuls les personnes membres de l'AÉDIROUM peuvent être candidates.

Toute mise en candidature doit préalablement recevoir l'assentiment de la personnes candidate.

Une élection doit avoir lieu pour chaque poste en jeu même s'il n'y a qu'une personne candidate en lice. Les membres peuvent toujours se prononcer contre l'ensemble des candidatures.
...
La présidence d'élection supervise le déroulement du scrutin, surveille le décompte ou le dépouillement des votes en présence des candidats ou de leurs représentants.

Lors d'un scrutin secret, la présidence d'élection doit rejeter les bulletins de vote qui n'indiquent pas de choix clair ou qui permettent d'identifier l'électeur.

Lors d'un scrutin à main levée, la présidence d'élection doit s'assurer qu'aucune personne électrice ne vote pour plus d'une personne candidate et que chaque voix exprimée n'est comptée qu'une seule fois.
...
\begin{description}
\item[Destitution] Lorsqu'une personne membre du Conseil Exécutif est destituée par les membres réunis en assemblée générale pour les motifs énoncés à l'\article{sec:scrutin}, l'élection de son successeur devrait avoir lieu au cours de la même assemblée générale.
\item[Autre cas] Dans tout autre cas de retrait du Conseil Exécutif pour les raisons évoquées à l'\article{sec:scrutin}, une assemblée ordinaire doit être convoquée pour élire la succession.
\item[Conseil d'Administration] Lorsqu'une personne membre du Conseil d'Administration est destituée ou se retire, il revient aux membres du Conseil d'Administration de se distribuer la tâche ou de nommer un remplacemnt jusqu'à la prochaine assemblée générale.
...
\begin{description}
\item[Présidence] La présidence est la première officière de l'AÉDIROUM et en est la porte-parole officielle. Elle coordonne le travail du Conseil d'Administration~: Elle convoque ses réunions, en propose l'ordre du jour et, généralement, en préside les séances (voir l'\article{sec:adjoints}). Elle est aussi membre d'office de tout comité de l'AÉDIROUM. Elle a la charge de convoquer les assemblées générales et les réunions du Conseil d'Administration.
\item[Vice-présidence interne] La vice-présidence interne est responsable de tout dossier concernant les relations entre les professeurs et ses membres ou les cours auxquels ses membres assistent. Elle doit consulter et informer les responsables d'année concernés lors du traitement de ces dossiers. Elle est déléguéd d'office de l'AÉDIROUM au comité des études et à l'assemblée départementale du DIRO. Elle remplace, en premier lieu, la présidence en cas d'absence ou d'incapacité de celle-ci.
\item[Vice-présidence externe] La vice-présidence externe assiste d'office aux réunions de tout organisme extérieur au DIRO afin d'y représenter l'AÉDIROUM. Elle est déléguée d'office sur le Conseil d'Administration de l'ADDIROUM. Elle remplace, en second lieu, la présidence en cas d'absence ou d'incapacité de celle-ci.
\item[Secrétariat] Le secrétariat a la charge de conserver les documents de l'AÉDIROUM, d'en produire la déclaration annuelle de personne morale auprès de l'Inspecteur général des institutions financièse et de tenir à jour une liste des membres de l'AÉDIROUM. Il rédige les comptes-rendus des assemblées générales ainsi que ceux des réunions du Conseil d'Administration. Ces comptes-rendus doivent être publiés sur le site web de l'AÉDIROUM la journée de leur adoption. À l'échéance de son mandat, il doit transmettre à son successeur tous les documents dont il a la garde.
\item[trésorerie] La trésorerie a la charge et la garde des fonds de l'AÉDIROUM et de ses livres de comptabilité. Elle prépare le budget annuel de l'AÉDIROUM et présente à l'assemblée générale régulière d'automne. Elle prépare un bilan annuel de l'AÉDIROUM et le présente à la dernière assemblée générale régulière d'hiver. Elle doit également faire un suivi de l'état des finances de l'AÉDIROUM lors de chaque assemblée générale ordinaire et réunion du Conseil d'Administration. À l'échéance de son mandat, elle doit transmettre à son successeur tous les documents dont elle a la garde. Elle a la charge de remplir le rapport d'impôts de l'AÉDIROUM à la fin de chaque année fiscale.
\end{description}
...
\item Coordonnation à la vie étudiante
\item Représentation du café étudiant Math-Info
...
Assure la communication entre l'AÉDIROUM et ses membres. A la responsablilité de contacter les membres qu'ils représentent au nom de l'AÉDIROUM et de rediriger les requêtes des membres qu'ils représentent à l'officier approprié. Se doit de rejoindre et mobiliser les membres pour prendre part aux actions de l'AÉDIROUM. Se doit d'avoir, au cours du mandat au moins un cours (en informatique) de l'année représentée; déterminé par le sigle. Dans le cas de la représentation de programme, se doit d'être inscrit au programme représenté.

\subsubsection{Représentation des personnes étudiant internationales}\label{sec:representant-des-etudiants-internationaux}

Assure la communication entre l'AÉDIROUM et ses membres qui ont un statut de personne étudiante internationale. Se doit de contacter les membres qu'elle représente au nom de l'AÉDIROUM et de rediriger les requêtes des membres qu'elle représente au poste approprié. Se doit de rediriger et mobiliser les membres pour prendre part aux actions de l'AÉDIROUM.

\subsubsection{Coordonnation à la vie étudiante}\label{sec:coordonnateur-a-la-vie-etudiante}

Est responsable devant le Conseil d'Administration de tout contact avec l'extérieur de l'AÉDIROUM concernant les activités sociales, culturelles et sportives.

Ses autres responsabilités sont définies par le Règlement de la vie étudiante.

\subsubsection{Représentation du café étudiant Math-Info}\label{sec:representant-du-cafe-etudiant-math-info}

Outre les tâches définies dans la charte du café, se doit de former un comité constitué de membres de l'AÉDIROUM pour remplir les postes requis par la charte du café. Représente l'administration du café devant l'assocation et le Conseil d'Administration devant l'administration du café.
...
S'assure de représenter les intérêts et préoccupations du Regroupement de Femmes en Informatique de l'Université de Montréal (RFIUM). Notamment, lors de toute assemblée générale, conseil administratif ou tout moment de prise de décision auquel participerait un ou plusieurs Membres du Conseil d'Administration, la personne responsable aura comme responsabilité de~:
\begin{itemize}
    ...
    \item Rappeler l'importance d'un effort pour augmenter la représentation des étudiantes femmes au sein du conseil exécutif de l'AÉDIROUM 
...
Doit être recommandée par le RFIUM avant de postuler à L'AÉDIROUM, avec approbation de 50\%+1 vote, lors d'une AG ou CA du RFIUM ayant eu lieu préalablement, soit durant la même session ou durant la session précédant celle-ci.  Le RFIUM doit avoir élu au moins 5 membres de son conseil administratif au moment de l'élection.
...
En Assemblée Générale, le poste est mentionné et l'Assemblée est informée de la personne nommée, et les Membres de l'Assemblée peuvent proposer une autre personne de confiance. S'il y a concurrence, un vote a lieu.

Durant les périodes où le Campus est peu achalandé, le Conseil Exécutif est invité à prioriser une personne membre qui est présente sur le Campus afin de maximiser l'accès au local pour les membres. Le Conseil Exécutif est également invité à prioriser une personne membre qui fait partie du Conseil d'Administration.
...
Les réunions du Conseil d'Administration peuvent être convoquées par la présidence ou par le secrétairiat. Elles peuvent aussi être convoquées lorsque quatre (4) membres du Conseil d'Administration en font une demande écrite par lettre ou par courrier électronique envoyé à la présidence ou au secrétairiat. La convocation doit avoir lieu au moins trois (3) jours ouvrables avant la réunion.
...
Les réunions du Conseil Exécutif sont typiquement présidées par la présidence de l'AÉDIROUM. Le secrétariat de l'AÉDIROUM agit typiquement comme secrétaire. Il revient aux membres du Conseil d'Administration de choisir parmi eux la présidence et le secrétaire d'assemblée au début de chaque réunion.
...
Par ailleurs le Conseil Exécutif peut destituer tout membre du Conseil Exécutif, ou du Conseil d'Administration absent sans motif lors de trois (3) réunions consécutives. S'il s'agit d'une personne membre du Conseil Exécutif, une assemblée générale extraordinaire doit alors être convoquée dans les plus brefs délais (voir l'\article{sec:convocation-generale}). La personne destituée peut appeler de la décision du Conseil Exécutif au cours de cette assemblée où les membres présents doivent approuver la décision par un vote à majorité aux deux tiers (\( \frac{2}{3} \)) (arrondi vers le haut).
...
Cesse de faire partie du Conseil Exécutif ou du Conseil d'Administration et d'occuper sa fonction toute personne membre qui se trouve dans l'une des situations suivantes~:
  \begin{itemize}
  \item présente par écrit sa démission au Conseil Exécutif;
  \item décède, devient insolvable ou incapable, est accusé d'un acte criminel selon le droit canadien;
  \item est destituée suivant l'une des procédures décrites par l'\article{sec:mandat}.
  \end{itemize}

\subsection{Rémunération}\label{sec:renumeration}

Ne sont rémunérés dans le cadre de l'exercice de leurs fonctions aucuns des membres du Conseil d'Administration. Ne peuvent non plus tirer profit financier d'activités faites au nom de l'AÉDIROUM.

\subsection{Indemnisation}\label{sec:indemnisation}

Toute personne membre du Conseil Exécutif, sa successions et ayants droit seront tenus, au besoin et à toute époque, à même les fonds de l'AÉDIROUM, indemnes et à couvert~:
\begin{itemize}
\item de tous frais, charges et dépenses quelconques qu'elle subit ou supporte au cours ou à l'occasion d'une action, poursuite ou procédure intenté contre elle, à l'égard ou en raison d'actes faits ou choses accomplies ou permises par elle dans l'exercice ou pour l'exécution de ses fonctions
\item de tous autres frais, charges et dépenses qu'elle supporte ou subit au cours ou à l'occasion des affaires de l'AÉDIROUM ou relativement à ces affaires, exceptés ceux qui résultent de sa propre néglicence ou de son omission volontaire.
\end{itemize}

\subsubsection{Procédure de preuve}\label{sec:procedure-de-preuve}

Afin qu'un membre du Conseil d'Administration, sa succession et ayants droits puissent se prévaloir des dispositions d'indemnisation, les factures originales doivent être présentées à la trésorerie de l'AÉDIROUM.

\subsection{Vacance}\label{sec:vacance}

Si un poste du Conseil Exécutif est vacant, la charge vacante est redistribuée entre les autres membres du Conseil Exécutif jusqu'à élection d'une personne remplaçante.
...
La présidence doit aussi être nommée et choisie par le Conseil d'Administration parmi les membres de l'AÉDIROUM. À la demande du Conseil d'Administration, la présidence d'un comité doit faire un rapport oral au Conseil d'Administration. À la fin du mandat, les activités du comité doivent cesser et la présidence du comité doit alors présenter, lors de la prochaine assemblée générale des membres, un rapport écrit du bilan du comité.
...
L'assemblée générale peut décréter la tenue d'un référendum et décider de sa date et du libellé de ses questions ou propositions, de même que d'un taux de participation minimal.
...
La présidence de référendum est nommée par le Conseil Exécutif. Pour chaque question ou proposition soumise au suffrage, la présidence, si elle a droit de vote, doit consigner son vote qui ne sera comptabilité qu'en cas d'égalité.
...
Tous les membres de l'AÉDIROUM ont droit de vote. Cependant, le vote de la présidence d'élection, si applicable, demeure secret et sans effet dans les cas où une option obtient la majorité des votes exprimés; son vote n'est comptabilisé qu'en cas d'égalité.
...
Le cahier de positions doit être mis à jour par le secrétariat de l'AÉDIROUM dans les cinq jours ouvrables suivant l'adoption, la modification, ou le retrait de positions ou de motions.
...
Le Conseil Exécutif et d'Administration de l'AÉDIROUM se doit de respecter les positions et motions contenues dans le cahier des positions.

Cependant, en l'absence d'une position contraire, une personne membre du Conseil Exécutif ou d'administration de l'AÉDIROUM peut toujours agir afin de défendre les intérêts des membres de l'AÉDIROUM.
...
Les cinq (5) personnes signataires de l'AÉDIROUM sont changées après chaque élection régulière en automne ou au besoin lorsque les membres du Conseil Exécutif ne sont plus les mêmes. Les personnes signataires sont les (5) membres du Conseil Exécutif.

\subsection{Effets bancaires}\label{sec:effets-bancaires}

Tous les chèques et autres effets bancaires de l'AÉDIROUM doivent être signés par deux (2) membres du Conseil Exécutif ou toutes autres personnes désignées par le Conseil Exécutif. Une personne signataire ne peut signer un chèque pour elle-même.
