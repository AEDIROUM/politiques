...
Les droits conférés à un membre sont conditionnels à ce qu'il acquitte entièrement sa cotisation
...
\section{Comités et groupes sous-représentés}\label{sec:comites}

\subsection{Modalités générales des comités}
...
\subsection{Modalités pour les groupes sous-représentés}

\subsubsection{Dispositions pour les groupes sous-représentés}

À toute époque, tout.e membre d'un groupe identitaire dit \textit{sous-représenté} et/ou \textit{désavantagé}, peu importe quel est ce groupe, voulant offrir une opportunité ou un service aux membres de son groupe a droit, sous réserve d'un vote par le conseil d'administration, à du soutien financier raisonnable pour le faire. Les canaux de communication sont également mis à la disposition des membres de ces groupes afin de promouvoir leurs initiatives auprès des membres.

Toute demande de soutien financier doit être faite de bonne foi, et doit être adressée au Conseil d'Administration. Le Conseil d'Administration doit évaluer la demande de manière objective, sans préférence ou distinction par rapport à l'identité du ou des demandeur.e.s.

Tout groupe identitaire est dit \textit{sous-représenté} si sa proportion, parmi l'ensemble des membres de l'AÉDIROUM, est significativement plus faible que sa proportion parmi la population générale.

Tout groupe identitaire qui se dit \textit{désavantagé} peut faire valoir son point devant le Conseil Administratif, même s'il n'est pas \textit{sous-représenté} au sein de l'AÉDIROUM.

Cependant, l'AÉDIROUM a un devoir d'égalité envers ses membres. Elle ne peut offrir d'elle-même un service ou une opportunité avec distinction, exclusion ou préférence fondée sur un ou plusieurs des aspects suivants: race, sexe, identité de genre, orientation sexuelle, religion, conviction, handicap, condition sociale. À titre d'exemple, un événement organisé au nom de l'AÉDIROUM ne peut être accessible qu'à tous ses membres. 

\subsubsection{Case budgétaire pour les groupes sous-représentés}
Tant et aussi longtemps que certains groupes se trouveront en \textit{sous-représentation} ou en \textit{désavantage}, une case budgétaire réservée au soutien à la diversité et à l'inclusion devra apparaître dans le budget.

Lors de la révision du budget en Assemblée Générale, cette case budgétaire est explicitement mentionnée, et l'Assemblée est informée des dispositions pour les groupes sous-représentés.
...
, en l'absence d'une position contraire, un membre du conseil exécutif ou d'administration de l'AÉDIROUM peut toujours agir afin de défendre les intérêts des membres de l'AÉDIROUM.
