...
\begin{description}
    \item \textbf{AG} Assemblée générale;
    \item \textbf{CA} Réunion du Conseil d'Administration;
    \item \textbf{Femme} Toute personne s'identifiant comme femme;
    \item \textbf{RFIUM} Regroupement de Femmes en Informatique de l'Université de Montréal.
\end{description}
