...
La présidence d'élection est nommée par les membres présents. La présidence d'élection ne peut être candidat.
...
Lors d'un scrutin à main levée, la présidence d'élection doit s'assurer qu'aucun électeur ne vote pour plus d'un candidat et que chaque voix exprimée n'est comptée qu'une seule fois.
...
\item[Vice-présidence interne] La vice-présidence interne est responsable de tout dossier concernant les relations entre les professeurs et ses membres ou les cours auxquels ses membres assistent. Elle doit consulter et informer les responsables d'année concernés lors du traitement de ces dossiers. Elle est délégué d'office de l'AÉDIROUM au comité des études et à l'assemblée départementale du DIRO. Elle remplace, en premier lieu, la présidence en cas d'absence ou d'incapacité de celle-ci.
\item[Vice-présidence externe] La vice-présidence externe assiste d'office aux réunions de tout organisme extérieur au DIRO afin d'y représenter l'AÉDIROUM. ELle est délégué d'office sur le Conseil d'Administration de l'ADDIROUM. Elle remplace, en second lieu, la présidence en cas d'absence ou d'incapacité de celle-ci.
...
Cesse de faire partie du Conseil Exécutif ou du Conseil d'Administration et d'occuper sa fonction tout membre qui se trouve dans l'une des situations suivantes~:
  \begin{itemize}
  \item La présentation par écrit sa démission au Conseil Exécutif;
  \item il décède, devient insolvable ou incapable, est accusé d'un acte criminel selon le droit canadien;
  \item La destitution suivant l'une des procédures décrites par l'\article{sec:mandat}.
  \end{itemize}

\subsection{Rémunération}\label{sec:renumeration}s
...
La présidence de référendum est nommée par le Conseil Exécutif. Pour chaque question ou proposition soumise au suffrage, la présidence, s'il a droit de vote, doit consigner son vote qui ne sera comptabilité qu'en cas d'égalité.
