...
L'AÉDIROUM a un devoir d'égalité envers ses membres. Elle ne peut offrir un service ou une opportunité avec distinction, exclusion ou préférence fondée sur un ou plusieurs des aspects suivants: race, sexe, identité de genre, orientation sexuelle, religion, conviction, handicap, condition sociale.

À toute époque, tout.e membre d'un groupe identitaire dit \textit{sous-représenté} et/ou \textit{désavantagé}, peu importe quel est ce groupe, voulant offrir une opportunité ou un service aux membres de son groupe a droit, sous réserve d'un vote par le conseil d'administration, à du soutien financier raisonnable pour le faire.
